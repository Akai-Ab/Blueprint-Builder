  ...
  return (
    ...
    >
      <div className="flex items-start justify-between">
        ...
        <div className={`ml-3 w-5 h-5 rounded-full border-2 flex items-center justify-center shrink-0 mt-0.5 ${
      ...
      {detail && selected && (
        <div className="mt-2 pt-2 border-t border-gray-100">
          ...
          {detail.advantages.length > 0 && (
            <div className="mt-1">
              <div className="text-xs font-medium text-gray-600">Advantages:</div>
